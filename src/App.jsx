...
const FUNDS_DEFAULT=[
    ...
    // ISIN vérifiés via WebSearch (sources : Carmignac, Sicavonline,
    // Quantalys, BlackRock, Pictet, LFDE officiels).
    ...
    {name:'BGF World Healthscience A2 H EUR',  isin:'LU1822774284', cat:'Actions Santé',           refSymbol:'AMEX:XLV',         refLabel:'XLV ETF',     color:'#0891B2'},
